...
WireGuard، x-ui، Hiddify و…) و همچنین بهینه‌سازی عمومی هر سرور لینوکسی.
...
| 📊 **ظرفیت‌محور** | سایز conntrack و بافرها بر اساس Capacity Tier یا **تعداد واقعی کاربر** (`--users`)، با نمایش تخمین مصرف RAM و هشدار صادقانه قبل از اعمال. |
...
- [x] **فاز ۲** — ماژول‌های بهینه‌سازی (sysctl / DNS / Swap+zram / Limits) + پروفایل‌ها + Capacity
